...
plt.plot(array_x, color='red', marker='o',label='Array X')
plt.plot(array_y, color='blue', marker='^',label='Array Y')
plt.plot(array_z, color='green', marker='s',label='Array Z')


# Add labels and a legend
plt.xlabel('Index')
plt.ylabel('Values')
plt.title('Gauss-Siedal Method')
plt.legend()
